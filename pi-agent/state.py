"""
State management for the pi-agent.

Tracks which pipeline phases have been completed and exposes
read/write helpers for the question plans and metadata store.
"""
...
def save_single_plan(idx: int, entry: dict):
    ...
    # Also update the coalesced file if it exists
    if PLANS_PATH.exists():
...
def get_pipeline_state() -> dict:
    ...
    The agent uses this to decide what to do next.
    """
    ensure_dirs()
